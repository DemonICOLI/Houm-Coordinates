import { CoordinatesTimeQueryPresenter } from "../../CoordinatesTimeQueryPresenter";
...
@injectable()
export class CoordinatesTimeQueryAWSApiGWPresenter implements CoordinatesTimeQueryPresenter {
